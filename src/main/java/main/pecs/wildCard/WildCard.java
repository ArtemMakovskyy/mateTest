...
public class WildCard {
    public static void main(String[] args) {
        ...
        List<Animal>animals = new ArrayList<>(List.of(new Animal("cat"),new Animal("dog")));
        List<Cat>cats = new ArrayList<>(List.of(new Cat("pusik"),new Cat("Music")));
...
//        printListWildCardExtends(cats);
    ...
    public static void printListWildCard(Collection<?> list) {
        System.out.println("\nif we don't know, what is the type of date is come in");
